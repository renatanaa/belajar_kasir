        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" min="0" max="100" class="form-control" id="tax_rate" name="tax_rate" value="{{ old('tax_rate', 0) }}">
                </div>
            </div>
            <div class="col-md-6">
                <h5>Products</h5>
                    ...
                    <div class="product-row mb-3 border p-3">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" min="1" class="form-control quantity-input" name="products[0][quantity]" value="1" required>
                            </div>
                            <div class="col-md-2">
